...
<div class="container">
	<div class="row login_box">
	    <div class="col-md-12 col-xs-12" align="center">
            <h1>สมัครสมาชิก</h1>
            <div class="outter"> <a href="<?php echo base_url('user/login'); ?>" ><img src="http://lorempixel.com/output/people-q-c-100-100-1.jpg" class="image-circle"/> </a></div>           
        ...
        <div class="col-md-12 col-xs-12 login_control">
                ...
                <div class="control">
                    ...
                    <input type="number" class="form-control" value="" id="phone" name="phone" placeholder="Enter your Phone"/>
                </div>
placeholder="Enter your Username"
                <div class="control">
                     <div class="label">Facebook</div>
                    <input type="text" class="form-control" value="" id="face" name="face" placeholder="Enter your Facebook"/>
                </div>

                <div class="control">
                     <div class="label">Line</div>
                    <input type="text" class="form-control" value="" id="line" name="line" placeholder="Enter your Line" />
                </div>
