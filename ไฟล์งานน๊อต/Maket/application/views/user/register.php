	...
	<div class="row login_box">
        ...
        <div class="col-md-12 col-xs-12 login_control">
                ...
                <div class="control">
                    ...
                    <input type="text" id="firstname" class="form-control" name="firstname" value="<?php echo $this->session->flashdata('firstname'); ?>" placeholder="Enter your firstname">
                </div>

                <div class="control">
                    <?php echo $this->session->flashdata('error_phone'); ?>
                     <div class="label">เบอร์โทร</div>
                    <input type="text" class="form-control" value="<?php echo $this->session->flashdata('phone'); ?>" id="phone" name="phone" placeholder="Enter your Phone"/>
                </div>

                <div class="control">
                    <?php echo $this->session->flashdata('error_facebook'); ?>
                     <div class="label">Facebook</div>
                    <input type="text" class="form-control" value="<?php echo $this->session->flashdata('facebook'); ?>" id="facebook" name="facebook" placeholder="Enter your Facebook"/>
                </div>

                <div class="control">
                    <?php echo $this->session->flashdata('error_line'); ?>
                     <div class="label">Line</div>
                    <input type="text" class="form-control" value="<?php echo $this->session->flashdata('line'); ?>" id="line" name="line" placeholder="Enter your Line" />
                </div>
                ...
                <div align="center">
                     <button class="btn btn-orange" type="submit">ยืนยัน</button>
                </div>
                </form>
        </div>
